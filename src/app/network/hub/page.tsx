...
export default function NetworkHubPage() {
  ...
  // Completed crosses (for trust indicator)
      ...
      <div className="max-w-6xl mx-auto p-6 lg:p-12 space-y-8 animate-in fade-in duration-500">
        ...
        <div className="relative overflow-hidden rounded-[2rem] border border-border/40 bg-card/40 p-7 lg:p-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <StepCard
              step="01"
              title="Availability Set Karein"
              description="Apne busy din mark karein — baqi din automatically available rahenge."
              icon={<CalendarDays className="w-5 h-5" />}
            />
            <StepCard
              step="02"
              title="Cross Bhejein ya Receive Karein"
              description="Professionals ko dhoondein ya dusron se cross requests receive karein."
              icon={<Handshake className="w-5 h-5" />}
            />
            <StepCard
              step="03"
              title="Reviews Se Reputation Banayein"
              description="Event complete karein, rating lein, aur Hafash par apni izzat barhayein."
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <TrustCard
            ...
            description="Sirf real aur trusted log — verify kiya gaya."
          />
          <TrustCard
            icon={<Star className="w-5 h-5" />}
            title="Honest Reviews"
            description="Har cross ke baad real feedback aur rating."
          />
          <TrustCard
            icon={<CheckCircle2 className="w-5 h-5" />}
            title="Secure Chat"
            description="Cross accept hone ke baad private chat."
          />
        </div>
          ...
          <Card className="relative overflow-hidden rounded-[2rem] border-primary/30 bg-gradient-to-br from-primary/15 via-card to-background shadow-2xl">
            ...
            <CardContent className="relative p-7 lg:p-10 text-center space-y-5">
              ...
              <Link href="/network/join">
                <button
                  type="button"
                  className="inline-flex items-center gap-2 px-6 h-12 rounded-2xl bg-primary text-primary-foreground hover:bg-primary/90 font-bold shadow-lg shadow-primary/25 transition-all hover:scale-105"
                >
                  Profile Banayein
...
function StatChip({
  ...
  return (
    <div className={cn(
      "rounded-2xl border px-3 py-2.5 bg-background/50 backdrop-blur-sm",
      highlight ? "border-primary/40 bg-primary/10" : "border-border/40"
    )}>
  ...
  return (
    <div className="relative space-y-3 group">
      <div className="flex items-center gap-3">
        ...
        <span className="text-3xl font-headline font-bold text-primary/20">
          {step}
        </span>
      </div>
